"""
Django base settings for Nobodies Profiles.
"""
import os
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://postgres:postgres@localhost:5432/nobodies',
        conn_max_age=600,
    )
}
...
# django-allauth settings (updated for v65+)
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'profiles@nobodies.team')
